...
Figs.graph_histogram(
    ...
    title='Cumulative Infection Duration under Annual MDA',
...
Figs.graph_histogram(
    ...
    title='Number of Infections per Patient Under Annual MDA',
...
Figs.graph_histogram(
    ...
    title='Number of Times Treated with Albendazole Under Annual MDA',
